...
wordcloud = WordCloud(font_path = font_path,width = 4096,height = 3072, max_words = 1000, min_font_size = 10, background_color = 'white').generate_from_frequencies(games_playtime)
